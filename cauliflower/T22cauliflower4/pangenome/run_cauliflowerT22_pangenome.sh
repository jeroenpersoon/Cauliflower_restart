...
# Set variables
CPU=24
tmpdir="/dev/shm/perso009/cauliflowerT22"


# List data
realpath ../QC/genomes_filtered/*.fna > cauliflowerT22_genomes.txt
realpath ../QC/annotations_filtered/*.gff | awk '{print FNR,$1;}' > cauliflowerT22_annotations.txt


# Build pangenome
pantools -Xmx50g -Xms10g build_pangenome --threads ${CPU} --scratch-directory ${tmpdir}/scratch ${tmpdir}/pangenome_4_DB cauliflowerT22_genomes.txt


# Add annotations
pantools -Xmx50g -Xms10g add_annotations --connect ${tmpdir}/pangenome_4_DB cauliflowerT22_annotations.txt
...
# BUSCO
pantools busco_protein --threads ${CPU} -Xmx50g --odb10=brassicales_odb10 pangenome_4_DB


# optimal grouping
pantools optimal_grouping --threads ${CPU} -Xmx50g pangenome_4_DB pangenome_4_DB/busco/brassicales_odb10
