...
df = read.csv("/lustre/BIF/nobackup/perso009/cauliflower/T22panproteome/panproteome/proteome_4_DB/optimal_grouping/fn_fp.csv", sep=",", header = TRUE)
...
pdf(NULL)
ggsave("/lustre/BIF/nobackup/perso009/cauliflower/T22panproteome/panproteome/proteome_4_DB/optimal_grouping/optimal_grouping.png", plot= plot1, height = 10, width = 15)
cat("\nPlot written to: /lustre/BIF/nobackup/perso009/cauliflower/T22panproteome/panproteome/proteome_4_DB/optimal_grouping/optimal_grouping.png\n\n")