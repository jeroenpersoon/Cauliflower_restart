...
# List data
realpath ../QC/proteins/*.faa > cauliflower4_proteomes.txt
...
# Build panproteome
pantools build_panproteome -Xmx50g -Xms10g proteome_4_DB cauliflower4_proteomes.txt
...
# gene classification
pantools gene_classification proteome_4_DB
