...
# Set variables
CPU=40
tmpdir="/dev/shm/perso009/T22species_oleracea15"


# List data
realpath ../QC/genomes_filtered/*.fna > T22species_oleracea15_genomes.txt
realpath ../QC/annotations_filtered/*.gff | awk '{print FNR,$1;}' > T22species_oleracea15_annotations.txt


# Build pangenome
pantools -Xmx100g -Xms50g build_pangenome --threads ${CPU} --scratch-directory ${tmpdir}/scratch ${tmpdir}/pangenome_15_DB T22species_oleracea15_genomes.txt


# Add annotations
pantools -Xmx100g add_annotations --connect ${tmpdir}/pangenome_15_DB T22species_oleracea15_annotations.txt
