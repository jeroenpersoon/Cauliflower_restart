...
# List data
realpath ../QC/proteins/*.faa > brassica_oleracea13_proteomes.txt


# Build panproteome
pantools build_panproteome -Xmx50g -Xms10g proteome_13_DB brassica_oleracea13_proteomes.txt
...
#grouping
pantools -Xmx100g -Xms50g group --relaxation 2 --threads ${CPU} proteome_13_DB


#classification
pantools gene_classification proteome_13_DB
