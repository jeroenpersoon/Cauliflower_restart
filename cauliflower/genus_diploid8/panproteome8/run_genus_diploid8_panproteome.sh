...
# List data
realpath ../QC/proteins/*.faa > genus_diploid8_proteomes.txt
...
# Build panproteome
pantools build_panproteome -Xmx50g -Xms10g proteome_8_DB genus_diploid8_proteomes.txt
...
# BUSCO
pantools busco_protein --threads ${CPU} -Xmx100g --odb10=brassicales_odb10 proteome_8_DB


# optimal grouping
pantools optimal_grouping --threads ${CPU} -Xmx100g proteome_8_DB proteome_8_DB/busco/brassicales_odb10
